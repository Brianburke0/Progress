...
package com.scriptmasters.progress.entity;
...
public class WaspEntity extends Monster implements GeoEntity {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ProgressModEntities.WASP.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
